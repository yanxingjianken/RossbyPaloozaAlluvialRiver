...
\partial_t v' + U_0\partial_s v' - C'U_0^2
 = -g\partial_n\R{(H_0+z_b)} - g\partial_n h' - \frac{C_fU_0v'}{H_0}
\end{equation}
\begin{equation}
...
= -\frac{g\mathcal{H}}{b}\dt_n\tilde h
...
= -\frac{\varepsilon_2}{\varepsilon_1Fr^2\alpha\gamma}\dt_n\tilde h
...
= \frac{1}{\varepsilon_1\alpha^2}\frac{\varepsilon_2}{Fr^2}\dt_n\tilde h,
\end{equation}
\begin{equation}
...
\begin{equation}
\R{\dt_t\tilde v}+\tilde\xi\dt_s\tilde v
= -\frac{\varepsilon_2}{\varepsilon_1Fr^2}\dt_n\tilde h
  - F_c\R{\frac{\tilde v}{\tilde\xi}},
\end{equation}
\begin{equation}
...
\R{\dt_t\tilde v}+\tilde\xi(\tilde n)\dt_s\tilde v
 ...
 + \frac{\varepsilon_2}{\varepsilon_1Fr^2\alpha^2}\dt_n\tilde h
